...
export default function Form() {
  ...
  return (
    <section>
      <form onSubmit={handleSubmit} className="bg-form-color max-w-xl">
        <h3 className=" text-lg font-semibold text-center pt-5">Create Cookie Stand</h3>
        <div className="">
          <label>Location</label>
          <input name='location' type='text' value={formInputs.location|| ''} onChange={handleChange} className=""></input>
        </div>
